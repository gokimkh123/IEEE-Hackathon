...
if __name__ == "__main__":
    ...
    ap.add_argument("--data_dir", type=str, default="data", help="Folder containing test_set.pkl")
    ap.add_argument("--save_dir", type=str, default="outputs", help="Location of best.pt & norm_stats.json")
    ap.add_argument("--out", type=str, default="NIST_Task1.pkl", help="Submission filename")
    ap.add_argument("--thr", type=float, default=0.5, help="Threshold for mask binarization")
    ap.add_argument("--feat", type=int, default=768, help="Number of CNN/GNN feature channels (same as train)")
    ap.add_argument("--gnn_layers", type=int, default=8, help="Number of GNN layers (same as train)")
